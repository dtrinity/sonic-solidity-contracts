...
import { DS_COLLATERAL_VAULT_CONTRACT_ID, S_ORACLE_AGGREGATOR_ID } from "../../typescript/deploy-ids";
...
func.tags = ["ds"];
func.dependencies = ["ds-collateral-vault", "s-oracle", "wS_HardPegOracleWrapper"];
