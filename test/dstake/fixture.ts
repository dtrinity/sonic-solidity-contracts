...
import { DS_CONFIG, DStableFixtureConfig, DUSD_CONFIG } from "../dstable/fixtures";
...
export const SDS_CONFIG: DStakeFixtureConfig = {
  ...
  deploymentTags: ["local-setup", "oracle", "ds", "dS-aTokenWrapper", "dlend", "dStake"],
};
...
export const SDSRewardsFixture = setupDLendRewardsFixture(SDS_CONFIG, "stS", ethers.parseUnits("100", 18));
