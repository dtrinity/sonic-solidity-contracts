...
import {
  DLoopCoreViewStub,
  DLoopDecreaseLeverageLogicHarness,
} from "../../../typechain-types";

describe("DLoopDecreaseLeverageLogic - encode/decode", () => {
  let harness: DLoopDecreaseLeverageLogicHarness;
  ...
  beforeEach(async () => {
    ...
    harness =
      (await Harness.deploy()) as unknown as DLoopDecreaseLeverageLogicHarness;
  });
