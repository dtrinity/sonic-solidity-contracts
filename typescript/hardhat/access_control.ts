 ...
 * @param adminToKeep - Address that should keep admin role
 * @param adminToRevoke - Address that should have admin role revoked
 * @param callerSigner - Signer to use for transactions
