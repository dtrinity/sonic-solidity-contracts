...
export const SFRXUSD_UPSCALE_DECIMAL_CONVERTER_ID = "ChainlinkDecimalUpscaler_sfrxUSD";

// S Oracles
export const S_ORACLE_AGGREGATOR_ID = "S_OracleAggregator";
export const S_API3_ORACLE_WRAPPER_ID = "S_API3Wrapper";
export const S_API3_WRAPPER_WITH_THRESHOLDING_ID = "S_API3WrapperWithThresholding";
export const S_API3_COMPOSITE_WRAPPER_WITH_THRESHOLDING_ID = "S_API3CompositeWrapperWithThresholding";
...
export const DS_REDEEMER_V2_CONTRACT_ID = "dS_RedeemerV2";
export const DS_COLLATERAL_VAULT_CONTRACT_ID = "dS_CollateralHolderVault";
export const DS_AMO_MANAGER_ID = "dS_AmoManager";
export const DS_AMO_MANAGER_V2_ID = "dS_AmoManagerV2";
export const DS_AMO_DEBT_TOKEN_ID = "dS_AmoDebtToken";
