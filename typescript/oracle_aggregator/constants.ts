...
export const ORACLE_AGGREGATOR_BASE_CURRENCY_UNIT =
  10n ** BigInt(ORACLE_AGGREGATOR_PRICE_DECIMALS);

export const ORACLE_CHAINLINK_AGGREGATOR_PRICE_DECIMALS = 8;
export const ORACLE_CHAINLINK_AGGREGATOR_BASE_CURRENCY_UNIT =
  10n ** BigInt(ORACLE_CHAINLINK_AGGREGATOR_PRICE_DECIMALS);
