...
library Errors {
    ...
    string public constant RESERVE_INACTIVE = "1"; // "Reserve is inactive"
    string public constant RESERVE_FROZEN = "2"; // "Reserve is frozen"
    string public constant RESERVE_PAUSED = "3"; // "Reserve is paused"
    string public constant BORROWING_NOT_ENABLED = "4"; // "Borrowing is not enabled"
    string public constant STABLE_BORROWING_NOT_ENABLED = "5"; // "Stable borrowing not enabled"
    string public constant COLLATERAL_BALANCE_IS_ZERO = "9"; // "The collateral balance is 0"
